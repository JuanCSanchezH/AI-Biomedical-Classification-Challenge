...
class MultiLabelEvaluator:
    ...
    def create_comparison_table(self, metrics_df):
        ...
        comparison_table = metrics_df[["rank", "model_name", "f1_weighted", "subset_accuracy", "hamming_loss"]].copy()
        ...
        for col in numeric_cols:
            if col in comparison_table.columns:
                comparison_table[col] = comparison_table[col].apply(lambda x: f"{x:.4f}" if pd.notna(x) else "N/A")
